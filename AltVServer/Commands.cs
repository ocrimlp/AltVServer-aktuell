...
namespace AltVServer
{
    public class Commands : IScript
    {
        ...
        {
            IVehicle veh = Alt.CreateVehicle(Alt.Hash(VehicleName), new AltV.Net.Data.Position(iplayer.Position.X, iplayer.Position.Y + 5.0f, iplayer.Position.Z), iplayer.Rotation);
            if(veh != null)
            {
        ...
        public void CMD_freezeme(IPlayer iplayer, bool freeze)
        {
            ...
            iplayer.SendChatMessage("{0B0404} Der freeze Befehl wurde ausgeführt!");
        }
    }
}
